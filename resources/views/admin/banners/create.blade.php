    ...
    <div class="max-w-4xl space-y-6">
        ...
        <form action="{{ route('banners.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-3xl p-8 border border-gray-100 shadow-[0_4px_25px_rgb(0,0,0,0.03)] space-y-6">
            ...
            <div>
                ...
                <input type="number" name="order_index" id="order_index" value="{{ old('order_index', 0) }}" class="w-full md:w-1/3 bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all font-medium" required>
            ...
            <div>
                ...
                <p class="text-xs text-gray-400 mt-2 font-medium">Format: JPG/PNG, Maksimal: 3MB. Rekomendasi resolusi: 1920x1080 (Lanskap).</p>
            </div>
