                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="button_text" id="button_text" value="{{ old('button_text', $banner->button_text) }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all font-medium">
                        </div>
                        <div>
                            <label for="button_link" class="block text-sm font-bold text-gray-700 mb-2">Link Tombol (Opsional)</label>
                            <input type="text" name="button_link" id="button_link" value="{{ old('button_link', $banner->button_link) }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all font-medium">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" name="order_index" id="order_index" value="{{ old('order_index', $banner->order_index) }}" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all font-medium" required>
                            <p class="text-[10px] text-gray-400 mt-1">Angka lebih kecil tampil lebih dulu.</p>
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-gray-700 mb-2">Ganti Gambar Latar (Opsional)</label>
                            ...
                            <p class="text-xs text-gray-400 mt-2 font-medium">Biarkan kosong jika tidak ingin mengubah gambar saat ini.</p>
                        </div>
                    </div>
