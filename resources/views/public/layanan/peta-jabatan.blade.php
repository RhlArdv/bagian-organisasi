    ...
    <section class="mb-16">
        <div class="max-w-7xl mx-auto px-5 lg:px-8">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8">
                ...
                {{-- FILTER & SEARCH BAR --}}
                <form action="{{ route('public.peta-jabatan') }}" method="GET" class="flex flex-wrap sm:flex-nowrap items-center gap-3 w-full lg:w-auto">
                    {{-- Search Input --}}
                    ...
                    @if(request()->filled('search') || (request()->filled('year') && request('year') != 'all'))
                        <a href="{{ route('public.peta-jabatan') }}" class="px-4 py-2.5 rounded-xl text-xs font-bold bg-gray-100 text-gray-600 hover:bg-gray-200 transition-colors shrink-0 flex items-center gap-1" title="Reset Filter">
