<x-public-layout :title="'Tata Laksana'" :metaDescription="'Dokumen SOP pelayanan, Peta Proses Bisnis, dan Tata Naskah Dinas Bagian Organisasi Sekretariat Daerah Kota Padang'">

    {{-- PAGE HEADER --}}
    <section class="pb-4 mb-8 border-b border-gray-200/60 max-w-7xl mx-auto px-5 lg:px-8">
        <h1 class="text-[28px] lg:text-3xl font-black text-[#1a202c] tracking-tight mb-2">Tata Laksana</h1>
        ...
        <div class="max-w-7xl mx-auto px-5 lg:px-8">
            <div class="relative bg-white rounded-[2.5rem] p-10 lg:p-14 shadow-[0_4px_25px_rgb(0,0,0,0.03)] border border-gray-100 overflow-hidden">
                ...
                <div class="relative z-10 flex flex-col lg:flex-row items-start lg:items-center gap-6">
                    ...
                    <div class="flex-1">
                        <h2 class="text-2xl lg:text-3xl font-black text-[#1a202c] mb-3 tracking-tight">Dokumen Tata Laksana</h2>
                        <p class="text-gray-600 font-medium leading-relaxed max-w-2xl">
                            ...
                            Meliputi Standar Operasional Prosedur (SOP), Peta Proses Bisnis, dan Tata Naskah Dinas untuk menjamin konsistensi dan kualitas pelayanan publik di seluruh perangkat daerah Kota Padang.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-5 lg:px-8">
                ...
                <div class="flex flex-wrap gap-2 mb-8">
                    @foreach($categories as $cat)
                        <button @click="activeTab = '{{ $cat->slug }}'"
                                :class="activeTab === '{{ $cat->slug }}' ? 'bg-blue-600 text-white shadow-lg shadow-blue-500/20' : 'bg-white text-gray-600 border border-gray-200 hover:border-blue-300 hover:text-blue-600'"
                        ...
                        @else
                            <div class="bg-white rounded-[2rem] p-12 text-center shadow-[0_4px_25px_rgb(0,0,0,0.03)] border border-gray-100">
                                <div class="w-20 h-20 mx-auto bg-blue-50 rounded-full flex items-center justify-center mb-6">
                                    <i class="ph-duotone ph-folder-open text-4xl text-blue-200"></i>
                                </div>
            ...
            @else
                <div class="bg-white rounded-[2.5rem] p-16 text-center shadow-[0_4px_25px_rgb(0,0,0,0.03)] border border-gray-100">
                    ...
                    <p class="text-sm text-gray-400 font-medium max-w-md mx-auto">Kategori Tata Laksana akan ditampilkan setelah dikonfigurasi.</p>
                </div>
            @endif
        </div>
    </section>
