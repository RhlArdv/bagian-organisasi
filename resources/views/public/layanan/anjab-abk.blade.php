<x-public-layout :title="'Analisis Jabatan & Analisis Beban Kerja'" :metaDescription="'Dokumen Anjab dan ABK Kota Padang — informasi analisis jabatan, analisis beban kerja, pedoman, dan formulir permohonan'">
    ...
    {{-- TABBED CATEGORIES --}}
    <section class="mb-10" x-data="{ activeTab: '{{ $categories->first()?->slug ?? '' }}' }">
        <div class="max-w-7xl mx-auto px-5 lg:px-8">
