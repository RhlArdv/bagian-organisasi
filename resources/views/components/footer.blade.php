    ...
    <div class="max-w-7xl mx-auto px-5 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li><a href="/profil" class="text-sm text-gray-400 font-medium hover:text-brand-400 transition-colors inline-flex items-center gap-2"><i class="ph-bold ph-caret-right text-[10px]"></i> Profil Organisasi</a></li>
                    <li><a href="/#kelembagaan" class="text-sm text-gray-400 font-medium hover:text-brand-400 transition-colors inline-flex items-center gap-2"><i class="ph-bold ph-caret-right text-[10px]"></i> Layanan Kelembagaan</a></li>
                    <li><a href="/#regulasi" class="text-sm text-gray-400 font-medium hover:text-brand-400 transition-colors inline-flex items-center gap-2"><i class="ph-bold ph-caret-right text-[10px]"></i> Regulasi & Aturan</a></li>
